...
- `docker compose exec core make test`: 210 core tests, 31 API tests, and flake8 passing.
...
- Step 5 file/image/storage coverage is partly done and now covers post-photo WebP conversion, thumbnail file creation, uploaded file deletion, static asset versioning, main S3 storage settings, and forum S3 storage settings. CKEditor upload/rich-text coverage still remains.
