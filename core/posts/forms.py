...
class ProfileAddPostForm(PostForm):
    ...
    def clean_rubric(self):
        user_rubric, _ = Category.objects.get_or_create(
            defaults={"slug": "%s-user" % self.cleaned_data["rubric"].slug},
            **{"parent": self.cleaned_data["rubric"], "value": "Статті користувачів"},
        )
        return user_rubric
