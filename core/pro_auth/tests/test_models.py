...
class UserModelTests(TestCase):
    ...
    def test_unique_email(self):
        self.assertRaisesMessage(UserFactory(email="avtokent1@test.com"), "A user with that email already exists.")

    def test_str_representation(self):
        self.assertEqual(str(self.user), "John Dou")
...
class UserManagerTests(TestCase):
    ...
    def test_crete_user_raises(self):
        ...
        with self.assertRaisesMessage(ValueError, "Superuser must have is_staff=True."):
            u.create_superuser(email="test@test.com", phone1="+380991234567", password="11111", is_staff=False)
        with self.assertRaisesMessage(ValueError, "Superuser must have is_superuser=True."):
            u.create_superuser(email="test@test.com", phone1="+380991234567", password="11111", is_superuser=False)
