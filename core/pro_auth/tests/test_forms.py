...
from core.pro_auth.forms import (
    AdminUserChangeForm,
...
class UserCreationFormTests(TestCase):
    ...
    def test_clean_password2(self):
        form = UserCreationForm(data={"password1": "12345", "password2": "12345"})
        form.is_valid()
        self.assertEqual(form.clean_password2(), "12345")
        form1 = UserCreationForm(data={"password1": "12345", "password2": "123"})
        form1.is_valid()
        self.assertRaisesMessage(form1.clean_password2(), "The two password fields didn't match.")
...
class UserChangeFormTest(TestCase):
    def test_valid_form(self):
        ...
        data = {"email": "newtest@test.com", "location": user.location.pk, "phone1": user.phone1}
