...
- Hid optional publication detail sections when their content is absent, including empty article bodies, registry data, products, related posts, adverts, and random posts.
...
- Detail-page browser checks for `/cybulevi/sorty-cybuli/ibis-2779.html` and `/holuby/porody-holubiv/ukrayinskyj-drakon-vystavkovyj-4076.html` confirmed absent optional content does not leave empty titled blocks.
