...
- Security header coverage for current `SecurityMiddleware`, clickjacking headers, and report-only CSP on the service worker endpoint plus representative public/template pages.
